...
function Mwatches() {
  ...
  useEffect(() => {
    api
      .get(`https://express-ecommerce-kappa.vercel.app/products/categories/mens-watches`)
  ...
  return (
    <div className="pageCont">
      <div className="pageCategory">
        <p className="categoryTitle">watches</p>
        <p className="categoryPara">
          Complete your look with our men's watches—sleek, reliable, and built
          to make a statement.
        </p>
      </div>
