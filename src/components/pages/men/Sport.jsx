  ...
  return (
    <div className="pageCont">
      <div className="pageCategory">
        <p className="categoryTitle">Sport Accessories</p>
        <p className="categoryPara">
          Gear up with our sport accessories—durable, functional, and designed
          to enhance every workout or outdoor adventure.
        </p>
      </div>
