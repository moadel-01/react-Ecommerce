...
function Bags() {
  ...
  useEffect(() => {
    api
      .get(`https://express-ecommerce-kappa.vercel.app/products/categories/womens-bags`)
  ...
  return (
    <div className="pageCont">
      <div className="pageCategory">
        <p className="categoryTitle">Women Bags</p>
        <p className="categoryPara">
          Discover trendy and elegant women's bags for every style. Perfect for
