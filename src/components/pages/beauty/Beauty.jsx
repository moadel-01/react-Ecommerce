  ...
  return (
    <div className="pageCont">
      <div className="pageCategory">
        <p className="categoryTitle">MakeUp</p>
        <p className="categoryPara">
          Discover our collection of women's makeup—featuring top-quality
          products that enhance your natural beauty with every application.
        </p>
      </div>
