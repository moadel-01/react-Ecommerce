...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    api
      ...
      .then((res) => {
        ...
        console.log("user data here", res.data.data);
        setUser(Data);
      })
  ...
  const handleSubmit = (e) => {
    ...
    //   setLoading(false)
    //   setMessage("Password length must be at least 8 characters")
    //   return
    // }
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                <label
                  ...
                  className="block text-sm/6 font-medium text-gray-900"
                >
                  If you want to change Password Enter you Old Password
                </label>
                <div className="mt-2">
                  <input
                    id="oldPassword"
                    ...
                    <div className="mt-2 grid grid-cols-1">
                      ...
                      >
                        <option
                          ...
                          selected
                          hidden
                        >{`choose one (current role is ${role})`}</option>
